...
exports.run = async(client, message, args) => {
    ...
    message.delete()
   if(!message.member.roles.cache.some(r => r.name === "") && !message.member.hasPermission("595903529898737664")) return message.reply("Bu Komutu Kullana Bilmek İçin Yönetici Permi Rolüne Olmalısınız.").then(message => {setTimeout(() => {message.delete()}, 60000);}) 
